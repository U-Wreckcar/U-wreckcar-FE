        ...
        <div>
          ...
          <section className={styles.l_section_eight}>
            <article>
              ...
              <div className={styles.e_cards}>
                <h1>About 유렉카</h1>
                <Link href="https://unexpected-ceder-0b7.notion.site/11f8741947a441e5822fd8723ef48492" target="_blank">
                  공지사항
                </Link>
                <Link href="https://unexpected-ceder-0b7.notion.site/0a3db0d8103f4be2855a23186fc1b5e3" target="_blank">
                  이용 가이드
                </Link>
              ...
              <div className={styles.e_cards}>
                <h1>Privacy & Terms</h1>
                <Link href="https://unexpected-ceder-0b7.notion.site/567d742a0cac4441991e88ac540c659e" target="_blank">
                  개인정보처리방침{" "}
                </Link>
