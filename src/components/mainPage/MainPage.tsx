...
export default function MainPageComponent() {
   ...
   const onClickDelBtn = () => {
      ...
      table?.getSelectedRowModel().flatRows.map((row: any) => id.push(row?.original))
   ...
   useEffect(() => {
      ...
      table
         ?.getSelectedRowModel()
         .flatRows.map((row: { original: MainTableType }) => id.push(row?.original))
      if (id.length === 0) {
   ...
   return (
      <div id="root">
         ...
         {alert && (
            <BtnAlert title={"성공"} contents={"UTM이 복사되었습니다!"} onClickEvent={setAlert} />
         )}
         <div className={styles.container}>
            <div className={styles.btn_box}>
               ...
               <div className={styles.buttons_box}>
                  ...
                  <button className={styles.plus_button} onClick={() => setPlus(true)}>
