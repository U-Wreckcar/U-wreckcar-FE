...
import ChangeText from "../render/ChangeText";
    ...
    <section className={styles.l_section_one}>
      <article>
        <div className={styles.text_box}>
          ...
          <Link prefetch={false} className={styles.origin_free_btn} href={"/login"}>
        ...
        <Link prefetch={false} className={styles.m_free_btn} href={"/webonly"}>
          <button id="free_btn" className={styles.free_btn}>
            무료로 시작하기
          </button>
        </Link>
